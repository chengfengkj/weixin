...
namespace WeiXin.Modules.Pay
{
    ...
    public class RequestUnifiedOrder
    {
        ...
        /// 普通商户
        /// </summary>
        /// <param name="body">商品简单描述，腾讯充值中心-QQ会员充值</param>
        /// <param name="outTradeNo">商户系统内部订单号</param>
        /// <param name="totalFee">单位：分</param>
        /// <param name="spbillCreateIp"></param>
        /// <param name="notifyUrl"></param>
        /// <param name="tradeType">交易类型JSAPI -JSAPI支付        NATIVE -Native支付 APP -APP支付</param>
        /// <param name="openid">用户标识,,trade_type=JSAPI时（即JSAPI支付），此参数必传,,trade_type=NATIVE时，OpenId应该为null</param>
